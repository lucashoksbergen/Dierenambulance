...
<body>
  ...
  <aside id="sidebar">
    ...
    <a href="#"><div class="logo"><img src="{{ asset('assets/img/LogoDAFRL-350x224-pub.jpg') }}" alt=""></div></a>
    ...
    <ul>
      <a href="#"><li class="{{ request()->routeIs('dashboard') ? 'active' : '' }}">My Profile</li></a>
    </ul>
